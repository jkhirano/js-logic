...
console.log('canVote: ', canVote(16));
...
console.log('isGreaterThan: ', isGreaterThan(5, 2));
...
console.log('spareChange: ', spareChange(20));
...
console.log('dirty30: ', dirty30(4, 10, 16));
...
console.log('evenStevens: ', evenStevens(6));
...
console.log('daClub: ', daClub(25, 25));
console.log('daClub: ', daClub(20, 25));
...
console.log('moneyTrain: ', moneyTrain(35));
console.log('moneyTrain: ', moneyTrain(65));
